We describe briefly the database creation and the search processes of  \textit{Network Method} then we detail our contributions in terms for developments in the data structure as well as a fast search strategy. 
