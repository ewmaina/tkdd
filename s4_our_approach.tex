...
The processing of subgraph matchings for isomorphism for each model graph terminates as soon a non-isomorphic subgraph or a subgraph with a \textit{dead} state is encountered, or the model graph is found to be isomorphic. 
