...
%%         point format={(%.1f,%.1f)},
       ...
       \addplot[mark=o] table[x=Density,y=NNA] \indsynQTenVslabelA;
       \addplot[mark=square] table[x=Density,y=NNA] \indsynQTenVslabelB;
       \addplot[mark=triangle] table[x=Density,y=NNA] \indsynQTenVslabelC;
       \addplot[mark=star] table[x=Density,y=NNA] \indsynQTenVslabelD;
