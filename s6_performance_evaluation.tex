...
\begin{figure}[h]
\centering
\include[width=1.0\textwidth]{realdataplot.tex}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{images/syndata_graphcount.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set} 
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{images/syndata_edegedensity.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set} 
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{images/syndata_labels.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set} 
\label{fig:labels}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{images/syndata_database.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set} 
\label{fig:database}
\end{figure}
