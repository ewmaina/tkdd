...
Top left: Linear plot of induced induced subgraph query processing time against query graph vertex count. 

Top Right: Linear-log plot of the induced subgraph graph query processing time with query graph size. 

Bottom left: Linear-linear plot of  subgraph query processing time for increasing size of graph query.

Bottom Right Linear-log plot of the  subgraph graph query processing time with query graph size. 
}
\label{fig:fig91}
\end{figure}
