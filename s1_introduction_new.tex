...
One of the few methods in literature for searching for all isomorphic subgraphs is based on the RETE algorithm. This aalgorithm was originally conceived for many pattern many target object matching problem in expert systems and has many variations that field. Its application in graphs theory is mainly due to the work of Bunke and Messmer\cite{messmer_bunke2000}.
