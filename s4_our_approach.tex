...
To implement a $DAG$ suitable for storage and search of subgraphs as well as induced subgraphs we need to provide methods that are suitable for decomposition of the subgraphs.
