...
%\pgfplotsset{ytick scale label code/.code={$\times 10^{#1}$}
       \addplot[mark=o,mark repeat=5,mark size=1pt] table[x=Q,y=NNA] \inducedsyndata;
        \addplot[mark=square,mark repeat=5,mark size=1pt] table[x=Q,y=VF2]  \inducedsyndata;
...
%          yticklabels={-0.25e8,2.0e8,4.0e8,6.0e8,8.0e8,1.0e9,1.2e9},
        ...
        \addplot[mark=square,mark repeat=5] table[x=Query,y=VF2]  \ninducedsyndata;  
      \end{axis}
    &[1mm]
%\pgfplotsset{ytick scale label code/.code={$\cdot 10^{#1}$}
      \begin{semilogyaxis}[yticklabel pos=right,
