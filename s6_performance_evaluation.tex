...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{syndataplot.tex}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{realdataplot.tex}
...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{syndata_graphcount.tex}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}} 
...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{images/syndata_edegedensity.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}} 
...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{syndata_labels.tex}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}}
\label{fig:labels}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{syndata_database.tex}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}}
\label{fig:database}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{syndataplot.tex}
\caption{\textbf{Results of the Experiments on the Synthetic Graph Data Set} 
