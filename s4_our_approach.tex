...
Further, the \textit{Fast Network Algorithm} is potentially more efficient as larger common subgraphs can be processed sooner, further reducing the potential search space.. 
