...
An extensive empirical study demostrates that the proposed algorithms result in an order of magnitude improvement in scalability over existing method for all subgraph isomorphism enumeration.
