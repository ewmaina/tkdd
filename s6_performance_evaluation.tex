...
\textt{(a)} Linear plot of induced subgraph query processing time against query graph vertex count and \textt{(b)} Linear-log plot of the induced subgraph graph query processing time with query graph size. 
