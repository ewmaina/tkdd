...
However enumeration of all subgraph isomorphisms requires solution of NP-complete subgraph isomorphism testing for detection stage only. Further, searching for features multiple times in query graphs also results in redundant computation.
