We describe briefly the database creation and the graph query search processes of  \textit{Network Method}. We further detail our contributions in terms for developments in the data structure as well as a new fast graph search strategy. 
