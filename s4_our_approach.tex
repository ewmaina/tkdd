...
We also evaluate the performance of induced subgraph query search where we observe several order of magnitude improvement in processing time for random graphs. 
