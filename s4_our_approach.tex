...
In this work we use a modified version of the $DAG$ data structure used in the \textit{Network Method}. We describe in detail this data structure, the modifications that we made of the \textit{Network Method}  
