...
Fig.\ref{fig:fig2} (II) shows an example of two model graphs that are decomposed and stored in a database in (II). A query is processed on this database in (III)
