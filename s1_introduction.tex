...
\begin{enumerate}
\item The previous work  RETE based graph search originally only supports induced subgraph isomorphism query. We porpose an algorithm for \textit{subgraph isomorphism} queries.
