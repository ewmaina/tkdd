...
We can classify a third, more recent and approach aims to reduce the cost of matching a query graph against a very large library of model graphs by representing the common subgraphs efficiently. One example of this approach was proposed by Messmer and Bunke \cite{messmer_bunke2000}. Their work is based on the RETE match algorithm \cite{Forgy1982}  initially applied to production matching in expert systems.
