...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{syndataedgedensity.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}} 
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{syndatalabels.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}}
\label{fig:labels}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{syndatadatabase.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}}
\label{fig:database}
\end{figure}
