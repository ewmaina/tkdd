...
\caption{\textbf{Effect of query Graph Size on Processing Time in Synthetic Graphs} 
...
\caption{\textbf{Effect of Labels on Processing Time in Synthetic Graphs}}
\label{fig:labels}
\end{figure}
...
\caption{\textbf{Effect of Edge Density on Processing Time in Synthetic Graphs}} 
