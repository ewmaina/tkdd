...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{images/syndata_graphcount.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}} 
...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{images/syndata_labels.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}}
\label{fig:labels}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphcs[width=1.0\textwidth]{images/syndata_database.pdf}
\caption{\textbf{Results of the Experiments on the Real World Graph Data Set}}
\label{fig:database}
\end{figure}
