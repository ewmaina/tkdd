...
We have two main contributions. We propose improvements in the core data structure to process both subgraphs and induced subgraphs and propose a new fast and scalable search strategy.
