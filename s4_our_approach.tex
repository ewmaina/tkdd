...
We also evaluate the performance of induced subgraph query search where we observe several orders of magnitude improvement in processing time over the \textit{Network Method} for random graphs. 
