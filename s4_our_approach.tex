...
We have two main contributions. We propose improvements in the core data structure to enable processing of both subgraphs and induced subgraphs, and propose a new fast and scalable search strategy for the database.
