...
\cite{bunke_glauser_tran1991} developed the their RETE inspired graph matching algorithm to match dynamically changing graphs to a large number of prototypes graphs.
The links  DAG network was constructed to represent addition of edges in the dynamic graph. These edges were added or deleted from the DAG to represent addition or removal of graph prototypes.   
