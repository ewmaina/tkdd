...
Fig.\ref{fig:fig11} shows an example of a subgraph isomorphism query. We also reformulate a  \textit{New Network Method (NNA)} to increase the scalability of this method.
...
\item We formulate and implement  a  \textit{New Network Method} on the offline preparation of the database. The new algorithm performs recombination 
...
\item We formulate and implement the \textit{New Network Method} for recombination of the decomposed query during  online query processing on the database.
