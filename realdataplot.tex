...
\begin{center}
   ...
   \pgfplotstableread[col sep=&,row sep=\\]{
      ...
      0 & 0 & 0 & 0 & 0 \\
      100 & 12.1 & 12.24 & 400391e-6 & 30917760e-6 \\
      200 & 16.5 & 16.80 & 1919648e-6 & 102039169e-6 \\
      300 & 21.06 & 21.70 & 9883433e-6 & 234524256e-6 \\
      400 & 25.79 & 26.72 & 12475437e-6 & 465056798e-6 \\
      500 & 30.59 & 31.82 & 24249592e-6  & 614153242e-6 \\
      606 & 35.33 & 36.81 & 39273662e-6 & 1083145839e-6 \\
    }\inducedrealdataAve
...
%\pgfplotsset{ytick scale label code/.code={$\times 10^{#1}$}
       \addplot[mark=o] table[x=Q,y=NNA] \inducedrealdata;
        ...
        \addplot[mark=o] table[x=QVertexAve, y=NNAPerQGraph] \inducedrealdataAve
         \addplot[mark=o] table[x=QVertexAve, y=VF2PerQGraph] \inducedrealdataAve
     \end{axis}
    &[1mm] 
