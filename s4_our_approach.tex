...
As shown in \ref{fig:fig3} for each model graph in the database, the search process will begin at the top, say $g_1$ and proceed recursively as long as the state of the present node is \texit{unsolved} or \textit{alive}.
