...
A Linear plot \texttt{(a)} and Linear-log plot \texttt{(b)} of induced subgraph query processing time against query graph size.

A Linear plot \texttt{(c)} and Linear-log plot \texttt{(d)} of  subgraph query processing time for increasing size of graph query.
}
\label{fig:fig91}
\end{figure}
