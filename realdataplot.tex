...
%%        \addplot[mark=square] table[x=Q,y=VF2]  \inducedrealdata;
         \node  at (axis cs:12,1.8) {Induced Isomorphism};
...
%        \addplot[mark=o] table[x=Q,y=NNA]  \inducedrealdata;
%        \addplot[mark=square] table[x=Q,y=VF2]  \inducedrealdata;
        \node  at (axis cs:18,1.7) {Induced Isomorphism};
        \addplot[mark=o] table[x=QVertexAve, y=NNAPerQGraph] \inducedrealdataAve;
        \addplot[mark=square] table[x=QVertexAve, y=VF2PerQGraph] \inducedrealdataAve;
        \addplot[mark=asterisk] table[x=QVertexAve, y=MessmerPerQGraph]  \inducedmessmerrealdataAve ;
      \end{semilogyaxis}
...
%%        \addplot[mark=square] table[x=Query,y=VF2]  \ninducedrealdata; 
        \node  at (axis cs:12,1.8) {Isomorphism};
...
%%        \addplot[mark=o] table[x=Query,y=NNA] \ninducedrealdata;
%%        \addplot[mark=square] table[x=Query,y=VF2]  \ninducedrealdata;  
        \node  at (axis cs:18,1.5) {Induced Isomorphism};
        \addplot[mark=o] table[x=QVertexAve, y=NNAPerQGraph] \ninducedrealdataAve;
         \addplot[mark=square] table[x=QVertexAve, y=VF2PerQGraph] \ninducedrealdataAve;
      \end{semilogyaxis}
\\
