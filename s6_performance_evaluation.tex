...
Top Right: Linear-log plot of the induce subgraph graph query processing time with query graph size. 

Bottom left: Linear-linear plot of  query processing time for increasing size of graph query.

Bottom Right Linear-log plot of the induce subgraph graph query processing time with query graph size. 
}
\label{fig:fig91}
\end{figure}
