...
One of the few methods in literature for searching for all isomorphic subgraphs is based on the RETE algorithm. This aalgorithm was originally conceived for many pattern many target object matching problem in expert systems and has multiple variations that field. Its application in graph theory is mainly due to the work of Bunke \cite{bunke_glauser_tran1991} and Messmer\cite{messmer_bunke2000}.
