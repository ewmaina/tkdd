...
One of the few methods in literature for searching for all isomorphic subgraphs is based on the RETE algorithm. This algorithm was originally conceived for many pattern many target object matching problem in forward chaining rule based systems is well researched in the field of Expert Systems. The application of RETE in graph theory however was first proposed by Bunke \cite{bunke_glauser_tran1991}. Subsequently a more efficient variation was proposed by Messmer\cite{messmer_bunke2000}.
