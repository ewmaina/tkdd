...
we develop a set of heuristics to match a database graph to a subgraph of the query
...
2. If a subgraph of the database graph does not exist in the query graph, the database graph is not a subgraph of the query graph.
3. 
To process a query graph we search the root of each database graph  
