We describe briefly the database creation and the graph query search processes of  \textit{Network Method}. We further detail our contributions main contributions: the developments of a new fast graph search algorithm implemented on a modified $DAG$ data structure as well as a new fast graph search strategy. 
