...
\textt{(c)} - Linear-linear plot of  subgraph query processing time for increasing size of graph query.

\textt{(d)} - Linear-log plot of the  subgraph graph query processing time with query graph size. 
}
\label{fig:fig91}
\end{figure}
