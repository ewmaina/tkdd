...
However enumeration of all subgraph isomorphisms requires NP-complete subgraph isomorphism testing for detection only. Further, searching for features multiple times in query graphs also results in redundant computation.
