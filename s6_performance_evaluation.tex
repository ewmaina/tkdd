...
\subsubsection{Effect of size of Query and Database graph size on  the processing time}The graphs in Figure.\ref{fig:fig91} below shows the graphs of the effect of Query and Database size on processing time.  
