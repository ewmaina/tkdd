...
Table.\ref{tab:table1} summarizes feasible approach to subgraph decomposition.
...
Fig.\ref{fig:fig55} shows the difference between two methods of decomposition.
Table.\ref{tab:table1} summarizes feasible approach to induced subgraph decomposition.
