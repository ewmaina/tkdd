...
The DAG network was constructed to represent edges in the dynamic graph. These edges were added or deleted from the DAG to represent addition or removal of graph prototypes.   
