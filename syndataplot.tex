...
%\pgfplotsset{ytick scale label code/.code={$\times 10^{#1}$}
       \addplot[mark=o,mark repeat=50] table[x=Q,y=NNA] \inducedsyndata;
        \addplot[mark=triangle,mark repeat=10] table[x=Q,y=VF2]  \inducedsyndata;
...
%          xticklabels={,,},
        ...
        \addplot[mark=o,mark repeat=10] table[x=Q,y=NNA]  \inducedsyndata;
        \addplot[mark=triangle,mark repeat=10] table[x=Q,y=VF2]  \inducedsyndata;
     \addplot[mark=asterisk] table[x=Q,y=Messmer] \inducedmesssyndata;
      \end{semilogyaxis}
      \\ 
...
%          yticklabels={-0.25e8,2.0e8,4.0e8,6.0e8,8.0e8,1.0e9,1.2e9},
        ...
        \addplot[mark=o,mark repeat=10] table[x=Query,y=NNA] \ninducedsyndata;
        \addplot[mark=triangle,mark repeat=10] table[x=Query,y=VF2]  \ninducedsyndata;  
      \end{axis}
    &[1mm]
%\pgfplotsset{ytick scale label code/.code={$\cdot 10^{#1}$}
      \begin{semilogyaxis}[yticklabel pos=right,
        scaled ticks=false,
         xlabel={Query Graph Size(# of vertices)},
          ...
          \addplot[mark=o,mark repeat=50] table[x=Query,y=NNA] \ninducedsyndata;
          \addplot[mark=triangle,mark repeat=50] table[x=Query,y=VF2]  \ninducedsyndata;
      \end{semilogyaxis}
\\
  };
\end{tikzpicture}
