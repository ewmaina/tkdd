...
\caption{\textbf{Effect of query Graph Size on Processing Time in Synthetic Graph} 
...
\caption{\textbf{Effect of GraphCount on Processing Time - Synthetic Graph Data Set}} 
...
\caption{\textbf{Effect of Labels on Processing Time - Synthetic Graph Data Set}}
\label{fig:labels}
\end{figure}
...
\caption{\textbf{Effect of Edge Density on Processing Time - Synthetic Graph Data Set}} 
...
\caption{\textbf{Results of the Experiments on the effect of query size - Real World Graph Data Set} 
